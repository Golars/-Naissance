...
<head>
	...
	<link href="{{$app['vergo_base.assets']->getPath('/css/admin.css')}}" rel="stylesheet">
	<link rel="stylesheet" href="{{$app['vergo_base.assets']->getPath('/css/loader.css')}}" >

	<script src="{{$app['vergo_base.assets']->getPath('/js/lib/jquery/jquery-2.1.3.min.js')}}"></script>

	<script type="text/javascript" src="{{$app['vergo_base.assets']->getPath('/js/lib/underscore/underscore-min.js')}}"></script>
	...
	<link href="{{$app['vergo_base.assets']->getPath('/css/loading.css')}}" rel="stylesheet">
</head>
...
<body class="nav-md">
	...
	<div class="container body">
		<div class="main_container">
				...
				<div class="left_col scroll-view">
					...
					<div class="profile">
						<div class="profile_pic">
							<img src="{{Request::user()->getCover()}}" alt="{{Request::user()->getFullName()}}" class="img-circle profile_img">
						</div>
					...
					<!-- sidebar menu -->
					@include('vergo_base::admin.layouts.menu')
					<!-- /sidebar menu -->
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="">
								<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<img src="{{Request::user()->getCover()}}" alt="">{{Request::user()->getFullName()}}
			...
			<div class="right_col" role="main">
				...
				<footer>
					<div>
						<p class="pull-right">VERGO Skillet Admin Panel. |
							for <span class="lead"> <i class="fa fa-copyright"></i> VERGO</span>
						</p>
					</div>
					<div class="clearfix"></div>
				</footer>
	...
	<script src="{{$app['vergo_base.assets']->getPath('/js/lib/nicescroll/jquery.nicescroll.min.js')}}"></script>
	<script src="{{$app['vergo_base.assets']->getPath('/js/lib/bootstrap/bootstrap.min.js')}}"></script>
	<!-- icheck -->
	<script src="{{$app['vergo_base.assets']->getPath('/js/lib/icheck/icheck.min.js')}}"></script>

	<!-- sparkline -->
	<script src="{{$app['vergo_base.assets']->getPath('/js/lib/sparkline/jquery.sparkline.min.js')}}"></script>

	<!-- PNotify -->
	<script type="text/javascript" src="{{$app['vergo_base.assets']->getPath('/js/lib/notify/pnotify.core.js')}}"></script>

	<script src="{{$app['vergo_base.assets']->getPath('/js/lib/custom.js')}}"></script>
